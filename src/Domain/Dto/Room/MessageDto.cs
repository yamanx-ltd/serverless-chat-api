...
public class MessageDto
{
    ...
    public SystemMessagePayloadDto? SystemMessage { get; set; }
    ...
    public class SystemMessagePayloadDto
    {
        public MessageEntity.SystemMessageType Type { get; set; }
...
public static class MessageDtoMapper
{
    ...
    public static MessageDto ToDto(this MessageEntity entity)
    {
        return new MessageDto
        {
            ...
            Parent = entity.ParentId == null ? null : new MessageDto { Id = entity.ParentId },
            MessageAttachment =
                entity.MessageAttachment == null
                    ? null
            ...
            MessageReactions = entity
                .MessageReactions.Select(q => new MessageDto.MessageReactionDto
                {
                    Reaction = q.Reaction,
                    Time = q.Time,
                    UserId = q.UserId,
            ...
            MessageStatus = entity
                .MessageStatus.Select(q => new MessageDto.MessageStatusDto
                {
                    Status = q.Status,
            ...
            SystemMessage =
                entity.SystemMessage == null
                    ? null
                    : new MessageDto.SystemMessagePayloadDto
                    {
                        AdditionalData = entity.SystemMessage.AdditionalData,
                        Type = entity.SystemMessage.Type,
                    },
        };
    }
}